...
function getRandomX() {
  // Put your code here!
  console.log("Executing putWordOnPageX()...");
  return Math.floor(Math.random() * window.innerWidth);
}

function getRandomY() {
  // Put your code here!
  console.log("Executing putWordOnPageY()...");
...
function insertWordOnPage(word, x, y){
  ...
  // 3) append the element to the "container" div
    ...
    var bode= document.createTextNode(word);
    h.appendChild(bode);
    ...
    h.style.top= y + 'px';
    containerDiv.appendChild(h);
    var randomC = pickRandomColor();
    h.style.color= randomC;
}
...
function findMatchingWord(text_input) {
  // Your code here!
  var bbs = document.getElementById("container").childNodes;
